...
G.prototype.toggle=function(){if(!this.disabled&&!$(this).hasClass("disabled")){var a=I(this),b=$(a).hasClass("open");H();if(b)return!1;"ontouchstart"in document.documentElement&&!$(a).closest(".navbar-nav").length&&(b=document.createElement("div"),b.className="dropdown-backdrop",$(b).insertBefore(this),$(b).on("click",H));var b={relatedTarget:this},c=$.Event("show.bs.dropdown",b);$(a).trigger(c);if(!c.isDefaultPrevented())return this.focus(),this.setAttribute("aria-expanded","true"),$(a).toggleClass("open"),
$(a).trigger("shown.bs.dropdown",b),!1}};$.fn.dropdown=function(a){return this.each(function(){var b=$(this).data("bs.dropdown");b||$(this).data("bs.dropdown",b=new G(this));"string"===typeof a&&b[a].call(this)})};$.fn.dropdown.Constructor=G;$.fn.dropdown.noConflict=function(){$.fn.dropdown=la;return this};
...
$.fn.tooltip.Constructor=T;$.fn.tooltip.noConflict=function(){$.fn.tooltip=ra;return this};if(!T)throw Error("Popover requires tooltip.js");function Y(a,b){T.call(this,a,b)}(function(){function a(){}a.prototype=T.prototype;Y.prototype=new a;Y.prototype.constructor=Y})();Y.VERSION="4.0.0";Y.Defaults=$.extend({},$.fn.tooltip.Constructor.Defaults,{placement:"right",trigger:"click",content:"",template:'<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'});
...
Z.prototype.show=function(){if(!this.a.parentNode||this.a.parentNode.nodeType!=Node.ELEMENT_NODE||!$(this.a).parent().hasClass("active")){var a,b,c=$(this.a).closest("ul:not(.dropdown-menu)")[0],d=m(this.a);c&&(b=$.makeArray($(c).find(".active")),(b=b[b.length-1])&&(b=$(b).find("a")[0]));var e=$.Event("hide.bs.tab",{relatedTarget:this.a}),f=$.Event("show.bs.tab",{relatedTarget:b});b&&$(b).trigger(e);$(this.a).trigger(f);f.isDefaultPrevented()||e.isDefaultPrevented()||(d&&(a=$(d)[0]),this.r($(this.a).closest("li")[0],
c),c=function(){var a=$.Event("hidden.bs.tab",{relatedTarget:this.a}),c=$.Event("shown.bs.tab",{relatedTarget:b});$(b).trigger(a);$(this.a).trigger(c)}.bind(this),a?this.r(a,a.parentNode,c):c())}};Z.prototype.r=function(a,b,c){var d=$(b).find("> .active")[0];b=c&&k&&(d&&$(d).hasClass("fade")||!!$(b).find("> .fade")[0]);a=this.aa.bind(this,a,d,b,c);d&&b?$(d).one("bsTransitionEnd",a).f(150):a();d&&$(d).removeClass("in")};
Z.prototype.aa=function(a,b,c,d){if(b){$(b).removeClass("active");var e=$(b).find("> .dropdown-menu > .active")[0];e&&$(e).removeClass("active");(b=$(b).find('[data-toggle="tab"], [data-toggle="pill"]')[0])&&b.setAttribute("aria-expanded",!1)}$(a).addClass("active");(b=$(a).find('[data-toggle="tab"], [data-toggle="pill"]')[0])&&b.setAttribute("aria-expanded",!0);c?(n(a),$(a).addClass("in")):$(a).removeClass("fade");a.parentNode&&$(a.parentNode).hasClass("dropdown-menu")&&((c=$(a).closest("li.dropdown")[0])&&
